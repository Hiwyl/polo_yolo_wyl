...
grid_size_multiplier = 8 #that is resolution of the output scale compared with input. So it is 1/4
...
def yolo_loss(args, anchors, num_classes, ignore_thresh=.5):
    ...
    for layer in range(num_layers):
        ...
        loss += (xy_loss + wh_loss + confidence_loss + class_loss)/ (K.sum(object_mask) + 1)
    return loss
...
if __name__ == "__main__":
    ...
    def _main():
        phase = 1
        annotation_path = 'cityscapes-train.txt'
        validation_path = 'cityscapes-val.txt'
        log_dir = 'd:/data-shared/tpami_paper/cityscapes/full_train/detector_v4_lite_wo_poly/'
        classes_path = 'yolo_classes.txt'
        anchors_path = 'yolo_anchors.txt'
